...
spec = do
  describe "convert CategoryRaw -> Category" $ do
    it "simple convert" $ do
      convertCategoryRawArray [CategoryRaw 1 "test" Nothing]
        `shouldBe` [Category 1 "test" Nothing]
